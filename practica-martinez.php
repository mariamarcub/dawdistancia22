...
/**
*Devuelve el cuadrado del numero 4
*
*@author María Martínez Cubiles
*@version 4.8 nano y 7.4 de PHP
*@param integer $num
*@return me devuelve el cuadrado del número seleccionado
*{@internal Obtenemos el número 16 al ser el cuadrado del número 4}
*/
